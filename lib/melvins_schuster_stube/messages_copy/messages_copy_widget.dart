...
class MessagesCopyWidget extends StatefulWidget {
  const MessagesCopyWidget({super.key});
...
class _MessagesCopyWidgetState extends State<MessagesCopyWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<MessageTagPermissionsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MessageTagPermissionsRow>
            messagesCopyMessageTagPermissionsRowList = snapshot.data!;
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: Visibility(
              visible:
                  (messagesCopyMessageTagPermissionsRowList.isNotEmpty) == true,
                                  ...
                                  itemBuilder: (context, messagesIndex) {
                                    ...
                                    return wrapWithModel(
                                      ...
                                      child: BoardPostWidget(
                                        key: Key(
                                          'Key705_${messagesItem.id.toString()}',
                                        ),
