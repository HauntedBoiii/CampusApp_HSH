...
import 'new_message_old_model.dart';
export 'new_message_old_model.dart';

class NewMessageOldWidget extends StatefulWidget {
  const NewMessageOldWidget({super.key});

  @override
  State<NewMessageOldWidget> createState() => _NewMessageOldWidgetState();
}

class _NewMessageOldWidgetState extends State<NewMessageOldWidget> {
  late NewMessageOldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewMessageOldModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserPermissionsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserPermissionsRow> newMessageOldUserPermissionsRowList =
            snapshot.data!;
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              if (newMessageOldUserPermissionsRowList
                                                  .where((e) =>
                                                      e.permission ==
