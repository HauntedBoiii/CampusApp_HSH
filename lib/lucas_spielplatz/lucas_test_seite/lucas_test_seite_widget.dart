...
import 'lucas_test_seite_model.dart';
export 'lucas_test_seite_model.dart';

class LucasTestSeiteWidget extends StatefulWidget {
  const LucasTestSeiteWidget({super.key});

  @override
  State<LucasTestSeiteWidget> createState() => _LucasTestSeiteWidgetState();
}

class _LucasTestSeiteWidgetState extends State<LucasTestSeiteWidget>
    with TickerProviderStateMixin {
  late LucasTestSeiteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LucasTestSeiteModel());
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(0.0, 4.0, 0.0, 4.0),
                                              child: Text(
                                                'Hallo, ich verkaufe mein Bett für 100 Geld',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelMedium
                                                    .override(
