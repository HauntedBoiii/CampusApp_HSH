...
import 'canteen_dish_widget_model.dart';
export 'canteen_dish_widget_model.dart';

class CanteenDishWidgetWidget extends StatefulWidget {
  const CanteenDishWidgetWidget({
    super.key,
  ...
  @override
  State<CanteenDishWidgetWidget> createState() =>
      _CanteenDishWidgetWidgetState();
}

class _CanteenDishWidgetWidgetState extends State<CanteenDishWidgetWidget> {
  late CanteenDishWidgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CanteenDishWidgetModel());
                            ...
                            await Navigator.push(
                              ...
                              PageTransition(
                                ...
                                child: FlutterFlowExpandedImageView(
                                  image: Image.network(
                                    'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxmb29kfGVufDB8fHx8MTcxOTI5MTA3MXww&ixlib=rb-4.0.3&q=80&w=1080',
                                    fit: BoxFit.contain,
                                  ),
                                  allowRotation: false,
                                  tag: 'productImageTag',
