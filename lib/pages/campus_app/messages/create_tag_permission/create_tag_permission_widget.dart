...
import 'create_tag_permission_model.dart';
export 'create_tag_permission_model.dart';

class CreateTagPermissionWidget extends StatefulWidget {
  const CreateTagPermissionWidget({
    super.key,
    required this.tagID,
  });
  ...
  @override
  State<CreateTagPermissionWidget> createState() =>
      _CreateTagPermissionWidgetState();
}

class _CreateTagPermissionWidgetState extends State<CreateTagPermissionWidget> {
  late CreateTagPermissionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateTagPermissionModel());
  }
                    ...
                    FutureBuilder<List<UserNamesRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FlutterFlowDropDown<String>(
                          ...
                          options: List<String>.from(dropDownUserNamesRowList
                              .map((e) => e.id)
                              .withoutNulls
                              .toList()),
                          ...
                          onPressed: () async {
                            ...
                            if (_model.dropDownValue != null &&
                              ...
                              _model.temp =
                                ...
                                'tag_id': widget.tagID,
                                'can_modify': _model.checkboxValue,
                              });
                              shouldSetState = true;
                              context.safePop();
                              if (containerMessageTagPermissionsRowList
                                      .where((e) =>
                                          e.userId == _model.dropDownValue)
                                      .toList()[0]
                                      .userId ==
                                  _model.dropDownValue) {
