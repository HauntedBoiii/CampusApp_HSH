  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserNamesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserNamesRow> userManagementPageUserNamesRowList = snapshot.data!;
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        controller: _model.userSelectDropDownValueController ??=
                            FormFieldController<String>(null),
                        options: userManagementPageUserNamesRowList
                            ...
                            .toList(),
                        onChanged: (val) async {
                          setState(() => _model.userSelectDropDownValue = val);
                          _model.selectedUserPermisssions =
                              await UserPermissionsTable().queryRows(
                            queryFn: (q) => q.eq(
                              'user_id',
                              userManagementPageUserNamesRowList
                                  .where((e) =>
                                      e.email == _model.userSelectDropDownValue)
                                  .toList()
                                  .first
                                  .id,
                            ),
                              ...
                              onChanged: (newValue) async {
                                ...
                                if (newValue!) {
                                  await _model.changePermission(
                                    ...
                                    granted: true,
                                    userId: userManagementPageUserNamesRowList
                                        .where((e) =>
                                            e.email ==
                        ...
                        Align(
                          ...
                          child: Theme(
                            ...
                            child: Checkbox(
                              ...
                              onChanged: (_model.userSelectDropDownValue ==
                                          null ||
                                      _model.userSelectDropDownValue == '')
                                  ? null
                                  : (newValue) async {
                              ...
                              activeColor:
                                  FlutterFlowTheme.of(context).tertiary,
                              checkColor:
                                  (_model.userSelectDropDownValue == null ||
                                          _model.userSelectDropDownValue == '')
                                      ? null
