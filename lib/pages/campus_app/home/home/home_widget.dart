...
import '/pages/campus_app/canteen_plan/no_canteen_offers/no_canteen_offers_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SavefoodOrderRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SavefoodOrderRow> homeSavefoodOrderRowList = snapshot.data!;
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      if (homeSavefoodOrderRowList.isNotEmpty)
                        Padding(
                      ...
                      if (FFAppState().widgetdata[0].visible)
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('MessagesCopy');
                          },
                          child: Container(
                            width: double.infinity,
                            decoration: BoxDecoration(
                                                    ...
                                                    builder:
                                                      ...
                                                      final textCanteensRow =
                                                          textCanteensRowList
                                                              ...
                                                              : null;
                                                      return Text(
                                                        'Essensausgabe: ${textCanteensRow?.foodDistributionDuringLectureTime}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                                    ...
                                    FutureBuilder<List<CanteenMealPlanRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<CanteenMealPlanRow>
                                            ...
                                            snapshot.data!;
                                        if (carouselCanteenMealPlanRowList
                                            .isEmpty) {
                                          return const NoCanteenOffersWidget();
                                        }
                                        return SizedBox(
                                          width: double.infinity,
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            functions.getFoodLabelIcons(carouselCanteenMealPlanRow.labels,
                              ...
                              FutureBuilder<List<SavefoodSellerRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<SavefoodSellerRow>
                                      containerSavefoodSellerRowList =
                                      snapshot.data!;
                                  return InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              return DishCardWidget(
                                                key: Key(
                                                    'Key3ii_${listViewIndex}_of_${listViewSavefoodOfferRowList.length}'),
                                                name: listViewSavefoodOfferRow
                                                    .name,
                                                menge: listViewSavefoodOfferRow
                                                    .quantity!
                                                    .toString(),
                                                ort: listViewSavefoodOfferRow
                                                    .seller!
                                                    .toString(),
                                                preis: listViewSavefoodOfferRow
                                                    .price!,
                                                abholzeit:
