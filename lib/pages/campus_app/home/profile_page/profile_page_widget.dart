  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UserPermissionsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserPermissionsRow> profilePageUserPermissionsRowList =
            snapshot.data!;
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed('ProfileSettings_Page');
                        },
                        child: Container(
                          width: double.infinity,
                          height: MediaQuery.sizeOf(context).height * 0.065,
                    ...
                    if (profilePageUserPermissionsRowList
                        .where((e) =>
                            (e.permission ==
                    ...
                    if (profilePageUserPermissionsRowList
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('UserManagement_Page');
                          },
                          child: Container(
                            width: double.infinity,
                            height: MediaQuery.sizeOf(context).height * 0.065,
                    ...
                    if (profilePageUserPermissionsRowList
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('TagManagement_Page');
                          },
                          child: Container(
                            width: double.infinity,
                            height: MediaQuery.sizeOf(context).height * 0.065,
                    ...
                    Align(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          context.goNamedAuth(
                              'LoginRegister_Page', context.mounted);
                        },
                        text: 'Abmelden',
