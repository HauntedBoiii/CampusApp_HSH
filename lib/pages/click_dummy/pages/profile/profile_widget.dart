                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<List<ProfilePicturesRow>>(
                              future: ProfilePicturesTable().querySingleRow(
                                queryFn: (q) => q.eq(
                                  'UserID',
                                  FFAppState().UserID,
                                ),
                              ...
                              builder: (context, snapshot) {
                                ...
                                final imageProfilePicturesRow =
                                    imageProfilePicturesRowList.isNotEmpty
                                        ? imageProfilePicturesRowList.first
                                        : null;
                                return ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl:
                                        imageProfilePicturesRow!.pictureUrl!,
                                    width: 60.0,
                                    height: 60.0,
                                    fit: BoxFit.cover,
